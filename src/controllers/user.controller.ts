...
export const loginUser = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!email || !password) { return next(errorHandler(400, "You must fill in all fields.")) }
...
export const AuthWithGoogle = async (req: Request, res: Response, next: NextFunction) => { //this function will allowed us to login or logout with google
