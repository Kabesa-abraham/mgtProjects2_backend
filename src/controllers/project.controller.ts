...
export const getAllProjectCreated = async (req: Request, res: Response, next: NextFunction) => {
    if (!req.user) {
    ...
    try {
        ...
        const projectCreated = await Project.find({ // projects that the user had created
        ...
        const projectParticipated = await Project.find({ //projects that the user had joined
        ...
        res.status(200).json({ //and we send all those datas
            projectCreated,
            projectParticipated,
...
export const getTheProject = async (req: Request, res: Response, next: NextFunction) => {
    const projectId = req.params.projectId;
    try {
